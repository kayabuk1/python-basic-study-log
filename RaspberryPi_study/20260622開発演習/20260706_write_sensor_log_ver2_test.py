...
'''実行結果：2026年7月6日16時16分分記録
pi@raspberrypi:~/share/development20260622~/sensor_log $ cat sensor_log.csv
"年-月-日 時:分:秒","光ｾﾝｻｰ値","温度(℃)","湿度(%)","土中水分ｾﾝｻｰ値","水ﾀﾝｸ内水 有無","水ポンプ起動有無","水ポンプ作動時間"
